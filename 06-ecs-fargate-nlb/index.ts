...
const nlb = new aws.lb.LoadBalancer("app-nlb", {
  internal: false,
...
const nlbTargetGroup = new aws.lb.TargetGroup("nlb-target-group", {
  port: 80,
  protocol: "TCP",
  vpcId: vpc.id,
  targetType: "ip",
...
const nlbListener = new aws.lb.Listener("nlb-listener", {
